    ...
    >
      <Image
        ...
        style={[
          ...
          data.data.from === "user" ? { marginLeft: 5 } : { marginRight: 5 },
        ]}
        resizeMode={"contain"}
      />
      <View
      ...
      >
        <Text
          style={[
            data.data.from === "user" ? { color: "white" } : { color: "black" },
          ]}
        >
          {data.data.text}
        </Text>
        {data.data.from === "user" ? (
          ...
          >
            <TouchableOpacity
              style={{ marginRight: 7 }}
              onPress={() => handleSpeaker(data.data.text)}
            >
              <Ionicons
            ...
            <TouchableOpacity
              ...
              onPress={() => copyToClipboard(data.data.text)}
            >
